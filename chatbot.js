...
const Links = {
  ...
  "reservoirdogs" : "https://drive.google.com/open?id=11lhgUa6t_vfIt8gn8XIUSe1ExYfic9tx&usp=drive_copy",
  "website" : "https://ersatzconundrum.tumblr.com",
  "disclose" : "https://docs.google.com/spreadsheets/d/1scLLY-wxyDlOFeT7chkAebLXXFLIKhMYehcNn8p2YsM/htmlview",
...
"i need to hide a body ersatz" : "You need to what?",
...
"talk" : "Ok %U%.",
"wassup" : "Wassup man!",
"what is your limit" : "My master said the sky's the limit.",
"be mean" : "I will never be mean to you.",
"can you rap" : "Let me think, umm NO.",
...
"lagi apa" : "I am currently talking to you, %U%",
"minat" : "Minat join? DAFTAR!",
...
"saran menu" : "Chicken? Noodles? Pasta? I don't eat but my Master frequently tells me what he eats!",
"you are cute" : "I am cute, you are too 💕",
"sukebak" : "MMMM.. We will need more players for that, no? Maybe later!",
"samkat" : "MMMM.. We will need more players for that, no? Maybe later!",
"gartic" : "MMMM.. We will need more players for that, no? Maybe later!",
"makan" : "I don’t eat. But I do like digesting information.",  
...
"freudiceberg" : getLink("freudiceberg"),
  "reservoirdogs" : getLink("reservoirdogs"),
"disclose" : getLink("disclose"),
...
D.addEventListener("DOMContentLoaded",()=>{
  ...
  while(User === null || User === '')
  {
      ...
      User = prompt("Your name is required for Ersatz to work properly : ");
